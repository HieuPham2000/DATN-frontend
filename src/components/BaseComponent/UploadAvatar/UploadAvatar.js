...
import RejectionFiles from '~/components/BaseComponent/RejectionFiles';
import { AddAPhoto as UploadIcon } from '@mui/icons-material';
import Image from '~/components/BaseComponent/Image';
...
export default function UploadAvatar({ error, file, disabled, helperText, sx, ...other }) {
    ...
    const hasFile = !!file; // có file

    const hasError = isDragReject || !!error; // có lỗi
